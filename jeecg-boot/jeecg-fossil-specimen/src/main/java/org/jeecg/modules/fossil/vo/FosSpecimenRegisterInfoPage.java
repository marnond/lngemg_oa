package org.jeecg.modules.fossil.vo;
 ...
 */
@Data
@ApiModel(value="fos_specimen_register_infoPage对象", description="古生物化石标本登记表")
public class FosSpecimenRegisterInfoPage {
	...
	@ExcelCollection(name="古生物化石标本流转记录表")
	@ApiModelProperty(value = "古生物化石标本流转记录表")
	private List<FosSpecimenCirculationInfo> fosSpecimenCirculationInfoList;
