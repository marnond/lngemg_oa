    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="标本来源:自采/购置/交换/捐赠/罚没/其它" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="specimenOrigin">
              <a-input v-model="model.specimenOrigin" placeholder="请输入标本来源:自采/购置/交换/捐赠/罚没/其它"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="模式标本:是/否" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="model">
              <a-input v-model="model.model" placeholder="请输入模式标本:是/否"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="模式类型:正模/副模/其它" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="modelType">
              <a-input v-model="model.modelType" placeholder="请输入模式类型:正模/副模/其它"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="标本去向:馆藏/借出研究/出境/国内展出/遗失/注销" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="specimenWhereabouts">
              <a-input v-model="model.specimenWhereabouts" placeholder="请输入标本去向:馆藏/借出研究/出境/国内展出/遗失/注销"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="保护级别:一级/二级/三级/待定" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="protectLevel">
              <a-input v-model="model.protectLevel" placeholder="请输入保护级别:一级/二级/三级/待定"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="标本状态:完好/破损" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="protectState">
              <a-input v-model="model.protectState" placeholder="请输入标本状态:完好/破损"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
    ...
    data () {
      return {
        ...
        validatorRules: {
           ...
           specimenOrigin: [
              { required: true, message: '请输入标本来源:自采/购置/交换/捐赠/罚没/其它!'},
           ],
           specimenPosition: [
              { required: true, message: '请输入标本位置!'},
           ],
           model: [
              { required: true, message: '请输入模式标本:是/否!'},
           ],
           specimenFamily: [
              { required: true, message: '请输入标本类别!'},
           ],
           specimenWhereabouts: [
              { required: true, message: '请输入标本去向:馆藏/借出研究/出境/国内展出/遗失/注销!'},
           ],
           protectLevel: [
              { required: true, message: '请输入保护级别:一级/二级/三级/待定!'},
           ],
           protectState: [
              { required: true, message: '请输入标本状态:完好/破损!'},
           ],
           serialId: [
